use wlr_lite_widget::{MouseButton, MouseResponse, Rectangle, SizeUnit, SkiaDrawArea, SkiaSurface, StandardDrawArea, SurfaceBox, SurfaceTrait, WidgetBuilder, WidgetPosition, WidgetSize, load_font};
use std::thread;
